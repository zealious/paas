...
curl -O $(curl -i -s "https://wordpress.org/plugins/wp-mail-smtp/" | egrep -o "https://downloads.wordpress.org/plugin/[^']+")
unzip -o "wp-super-cache".*.zip -d $(pwd)/wp-content/plugins
unzip -o "wp-mail-smtp".*.zip -d $(pwd)/wp-content/plugins
